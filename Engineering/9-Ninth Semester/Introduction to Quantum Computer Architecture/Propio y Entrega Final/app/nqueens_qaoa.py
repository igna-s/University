...
if __name__ == "__main__":
    ...
    n_qubits = N * N
    REPS   = 6      # OPTIMO: mas capas mejoran precision, pero reps>8 causa barren plateaus
    SHOTS  = 8192   # mas shots = estadistica mas precisa
    MAXITER = 500   # iteraciones del optimizador COBYLA
    ...
    np.random.seed(0)
    best_opt = None
    N_TRIALS = 8   # reinicios: reduce chances de quedar en minimo local
