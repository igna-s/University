...
import prog3.Pila_Cola.NodoGenerico;
...
public class ListaGenericaEnlazada<T> extends ListaGenerica<T> {
	...
	private ListaGenericaEnlazada<T> XD(ListaGenericaEnlazada<T> l,ListaGenericaEnlazada<T> ret) {
	...
	public ListaGenericaEnlazada<T> invertir() {
		this.comenzar();
		ListaGenericaEnlazada<T> ret = new ListaGenericaEnlazada<T>();
